...
<pre> __   _______   _____             _           _     
 ...
 /_/ \_\_|    |_____/ \___|\___| |______\__,_|_.__/ 
      ...
      <h2>XPSec Lab</h2>
      <p>File Inclusion - Level 2</p>
<hr>
    </div>
<center>
      <a href=lvl2.php?file=1.php><button class="btn btn-primary">Registro</button></a>
      <a href=lvl2.php?file=2.php><button class="btn btn-primary">Cursos</button></a>
      </div>
      ...
      <?php         
        ...
        if (isset( $_GET[ 'file' ])) 
        {
          ...
          $secure2 = str_replace( array( "http://" , "https://" ) ,"" , $secure2 );
            ...
            {        
              @include($secure2);
              echo"<div align='center'>".$secure2."</div> ";   
            }
        }              
      ?>
   </body>
